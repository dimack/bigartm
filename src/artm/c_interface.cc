...
static void ParseFromArray(const char* buffer, size_t length, google::protobuf::Message* message) {
...
int ArtmConfigureLogging(size_t length, const char* configure_logging_args) {
  try {
...
int ArtmCopyRequestImpl(size_t length, char* address, std::string* source) {
  try {
    if (source == nullptr) {
      std::stringstream ss;
...
int ArtmDuplicateMasterComponent(int master_id, size_t length, const char* duplicate_master_args) {
  try {
    EnableLogging();
...
int ArtmCreateMasterModel(size_t length, const char* master_model_config) {
  try {
    EnableLogging();
...
int ArtmAsyncProcessBatches(int master_id, size_t length, const char* process_batches_args) {
  try {
...
int ArtmAwaitOperation(int operation_id, size_t length, const char* await_operation_args) {
  try {
...
int ArtmAttachModel(int master_id, size_t length, const char* attach_model_args, int address_length, char* address) {
  try {
...
size_t ArtmParseCollection(size_t length, const char* collection_parser_config) {
  try {
    EnableLogging();
...
size_t ArtmRequestLoadBatch(const char* filename) {
  try {
    EnableLogging();
...
int ArtmExecute(int master_id, size_t length, const char* args_blob, FuncT func) {
  try {
    ArgsT args;
...
template<typename ArgsT, typename FuncT>
int ArtmExecute(int master_id, size_t length, const char* args_blob, const char* name, FuncT func) {
  try {
    ArgsT args;
    ParseFromArray(args_blob, length, &args);
...
size_t ArtmRequest(int master_id) {
  try {
    ResultT result;
...
size_t ArtmRequest(int master_id, size_t length, const char* args_blob) {
  try {
    ArgsT args;
    ResultT result;
    ParseFromArray(args_blob, length, &args);
...
template<typename ArgsT, typename ResultT>
size_t ArtmRequestExternal(int master_id, size_t length, const char* args_blob) {
  try {
    ArgsT args;
    ResultT result;
    ParseFromArray(args_blob, length, &args);
...
size_t ArtmRequestScore(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::GetScoreValueArgs,
                      ::artm::ScoreData>(master_id, length, args);
}

size_t ArtmRequestScoreArray(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::GetScoreArrayArgs,
                      ::artm::ScoreArray>(master_id, length, args);
}

size_t ArtmRequestDictionary(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::GetDictionaryArgs,
                      ::artm::DictionaryData>(master_id, length, args);
}

size_t ArtmRequestMasterComponentInfo(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::GetMasterComponentInfoArgs,
                      ::artm::MasterComponentInfo>(master_id, length, args);
}

size_t ArtmRequestProcessBatches(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::ProcessBatchesArgs,
                      ::artm::ProcessBatchesResult>(master_id, length, args);
}

size_t ArtmRequestProcessBatchesExternal(int master_id, size_t length, const char* args) {
  return ArtmRequestExternal< ::artm::ProcessBatchesArgs,
                              ::artm::ProcessBatchesResult>(master_id, length, args);
}

size_t ArtmRequestMasterModelConfig(int master_id) {
  return ArtmRequest< ::artm::MasterModelConfig>(master_id);
}

size_t ArtmRequestThetaMatrix(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::GetThetaMatrixArgs,
                      ::artm::ThetaMatrix>(master_id, length, args);
}

size_t ArtmRequestThetaMatrixExternal(int master_id, size_t length, const char* args) {
  return ArtmRequestExternal< ::artm::GetThetaMatrixArgs,
                              ::artm::ThetaMatrix>(master_id, length, args);
}

size_t ArtmRequestTopicModel(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::GetTopicModelArgs,
                      ::artm::TopicModel>(master_id, length, args);
}

size_t ArtmRequestTopicModelExternal(int master_id, size_t length, const char* args) {
  return ArtmRequestExternal< ::artm::GetTopicModelArgs,
                              ::artm::TopicModel>(master_id, length, args);
}

size_t ArtmRequestTransformMasterModel(int master_id, size_t length, const char* args) {
  return ArtmRequest< ::artm::TransformMasterModelArgs,
                      ::artm::ThetaMatrix>(master_id, length, args);
}

size_t ArtmRequestTransformMasterModelExternal(int master_id, size_t length, const char* args) {
